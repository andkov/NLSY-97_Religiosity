...
# attcol3<-c("blue2","blue2","snow", "snow", "snow", "red2" ,"red2", "red2")#GiA332
attcol3<-c("blue2","snow","snow", "snow", "red2", "red2" ,"red2", "red2")#GiA431
...
drawing<-"MovingWristBand-GiA431"  # name of drawing and folder in "03 writing and drawing" directory
cohortYear <- 1984
...
slide<-"slide00"
dsFORp <- subset(dsL_attend, cohort %in% allCohorts) # dsL_catatrans dsL_attend
#------------------------------------------------------#
